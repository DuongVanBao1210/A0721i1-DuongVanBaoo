package ss16_io_text_file.bai_tap.bai1_copy_file_text;
...
public class CopyFileText {
	   ...
	   static final String SOURCEFILE ="src/ss16_io_text_file/bai_tap/bai1_copy_file_text/test.txt";
	   static final String DESTINATIONFILE ="src/ss16_io_text_file/bai_tap/bai1_copy_file_text/file_copy.txt";
	   private static void copyFileJava(String source,String des) throws IOException {
